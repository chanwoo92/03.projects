...
//		LOGGER.debug(vo.toString());
	...
	@Override
	public int countByUserId(BoardVO vo) {
		return boardDAO.countByUserId(vo);
	}
...
//				LOGGER.debug(vo.toString());
	...
	public String findByUserName(BoardVO vo) throws Exception {
		return boardDAO.findByUserName(vo);
	}
